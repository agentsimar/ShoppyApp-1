...
/**
 * Created by Gursimran on 13-11-2017.
 */
...
public class PaymentPreview extends Activity{
    ...
    public void navigateToBaseActivity(View view) {
        ...
        merchantKey = "59EKIRcF";
        String email = "tomsmith20@myself.com";
        String amount = "10";
        ...
        mPaymentParams.setPhone("phone_cover");
    ...
    private class GetHashesFromServerTask extends AsyncTask<String, String, PayuHashes> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(PaymentPreview.this);
